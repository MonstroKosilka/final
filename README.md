...
* **Docker** >= 24
* **Docker Compose** (v2)
* ОС: Linux / macOS / Windows (Docker Desktop + WSL2)
...
Все данные мониторинга сохраняются в Docker volumes:
...
* ❌ **НЕ** используйте:
  ...
  (это удалит все данные мониторинга)
...
После запуска вы получаете полностью готовую локальную среду:
